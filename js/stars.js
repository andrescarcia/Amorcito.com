...
function animate() {
    ...
    if(flag) createMountainRange(1, canvas.height * 0.7, '#1b3d1b'); // Verde oscuro
    if(flag) createMountainRange(2, canvas.height * 0.6, '#163316'); // Verde más oscuro
    if(flag) createMountainRange(3, canvas.height * 0.4, '#0f260f'); // Verde aún más oscuro
    c.fillStyle = '#182028'
